// ▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬
// lib/profile.js — профиль + отзывы + рейтинг
// ▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬
...
const handleProfileCallback = async (data, ctx) => {
  ...
  // ═══════════ ВЫБОР ОЦЕНКИ (после нажатия на задание) ═══════════
  ...
  if (data.startsWith('rev_set_')) {
    ...
    await edit(
      ...
      `_Хочешь добавить комментарий? Ответь на это сообщение текстом._\n\n` +
      `Или нажми «К профилю»`,
      'Markdown',
      { inline_keyboard: [[{ text: '🔙 К профилю', callback_data: 'profile' }]] }
    );
  ...
  // ═══════════ ПРОЧИЕ (сохранены из твоего файла) ═══════════
  ...
  // ⭐ ТОП ПО РЕЙТИНГУ (новая категория)
